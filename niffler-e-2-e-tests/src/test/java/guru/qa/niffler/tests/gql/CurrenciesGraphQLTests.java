...
public class CurrenciesGraphQLTests extends BaseGraphQLTest {


    @User
    @ApiLogin
    @Test
    void allCurrenciesShouldBeReturnedFromGatewayTest(@Token String bearerToken) {
        ...
        Assertions.assertEquals(CurrencyValues.RUB.name(),
                all.get(0).currency.rawValue);

        Assertions.assertEquals(CurrencyValues.KZT.name(),
                all.get(1).currency.rawValue);

        Assertions.assertEquals(CurrencyValues.EUR.name(),
                all.get(2).currency.rawValue);

        Assertions.assertEquals(CurrencyValues.USD.name(),
